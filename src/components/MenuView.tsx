          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
            ...
            <div className="text-center md:text-right">
              ...
              <div className="flex items-center justify-center md:justify-end gap-3">
                ...
                <a href={(settings as any)?.tiktok || 'https://vt.tiktok.com/ZSXj8qdBa/'} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-black/5 dark:bg-white/5 flex items-center justify-center hover:bg-[#D4AF37]/10 hover:text-[#D4AF37] text-black/60 dark:text-white/60 transition-all">
