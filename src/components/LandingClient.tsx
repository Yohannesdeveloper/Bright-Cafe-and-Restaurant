        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="pt-8 border-t border-white/[0.06] flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href={(settings as any)?.tiktok || '#'} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center hover:bg-[#D4AF37]/10 hover:text-[#D4AF37] text-white/30 transition-all">
